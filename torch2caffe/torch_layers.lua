...
M.CONVERTER = {
    ...
    ['nn.SpatialUpSamplingNearest'] = simple{typename='caffe.SpatialUpSamplingNearest'},
    ['nn.SpatialUpSamplingBilinear'] = simple{typename='caffe.SpatialUpSamplingBilinear'},
